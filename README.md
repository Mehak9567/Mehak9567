...
- **Cybersecurity**: CEH fundamentals, penetration testing basics  
- **Tools**: GitHub, VS Code, Jupyter Notebook  
- **Other**: Microsoft Word, Excel, PowerPoint  

---

## 📂 Projects
### 🤖 Discord Bot  
A custom bot with automation features, commands, and interactions.  
🔗 [View Project](https://github.com/Mehak9567/discord-bot)  

### 🖼️ Image Classifier  
Built a machine learning model to classify images into categories.  
🔗 [View Project](https://github.com/Mehak9567/image-classifier)  

---

## 📜 Certifications
- ✅ **Certified Ethical Hacker (CEH)**  
- 📊 Other IT-related workshops & hackathons  
...
⭐️ *“Passionate about learning, building, and innovating — always ready to take on challenges!”*
